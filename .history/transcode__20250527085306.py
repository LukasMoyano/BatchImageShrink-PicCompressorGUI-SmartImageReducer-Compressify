...
print(f"\n🎉 Compresión terminada. Archivos guardados en: {output_folder}")
input_folder = "/home/userx/Pictures/ProfilesPics/FotoFusa_lks"from PIL import Image
import os
...
print(f"\n🎉 Compresión terminada. Archivos guardados en: {output_folder}")
output_folder = f"{input_folder}_comprimidas"from PIL import Image
import os
...
print(f"\n🎉 Compresión terminada. Archivos guardados en: {output_folder}")
quality = 85  # Ajusta de 1 (peor) a 100 (mejor)from PIL import Image
import os
...
print(f"\n🎉 Compresión terminada. Archivos guardados en: {output_folder}")
os.makedirs(output_folder, exist_ok=True)from PIL import Image
import os
...
print(f"\n🎉 Compresión terminada. Archivos guardados en: {output_folder}")
for img_file in os.listdir(input_folder):from PIL import Image
import os
...
print(f"\n🎉 Compresión terminada. Archivos guardados en: {output_folder}")
    if img_file.lower().endswith(".jpg"):from PIL import Image
import os
...
print(f"\n🎉 Compresión terminada. Archivos guardados en: {output_folder}")
        img = Image.open(os.path.join(input_folder, img_file))from PIL import Image
import os
...
print(f"\n🎉 Compresión terminada. Archivos guardados en: {output_folder}")
        img.save(os.path.join(output_folder, img_file), "JPEG", quality=quality)pip3 install Pillowfrom PIL import Image
import os
